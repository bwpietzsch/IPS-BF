...
to setup
  ...
  ; remove faulty target and source trees: all trees that are more than 125 m away from the target infestation
  ; pattern located in the middle of the simulation world
  ask patch 50 50 [
    ask patches with [distance myself > 25 and inf != 0] [
  ...
  set swarming 50
  set windspeed 4.0
  set generations (ifelse-value
      path-to-input = "input/B/" [ 1 ]
      path-to-input = "input/E/" [ 1 ]
                                 [ 2 ])
